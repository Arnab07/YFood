...
class reg_cook extends CI_Controller {
    ...
    function reg()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
                ...
                'cook_pass' => $this->encrypt->encode($this->input->post('dpass')),
    ...
    function cook_reg()
    {
        $this->load->library('../controllers/cook_reg');
        redirect('cook_reg');
    }

    function user_reg()
    {
        $this->load->library('../controllers/user_reg');
        redirect('user_reg');
